...
public class TechSupportService {
    ...
    private PollableChannel updateNotificationChannel; //QueueChannel
    ...
    private void checkVersionCurrency() {
        ...
        updateNotificationChannel.send(MessageBuilder.withPayload("Application update required.").build(), 1000); //Bloquea máximo 1 segundo en caso no haya capacity
    }
